...
contextBridge.exposeInMainWorld("stayline", {
  ...
  switchAccount: (id) => ipcRenderer.invoke("stayline:switch-account", id),
  addAccount: () => ipcRenderer.invoke("stayline:add-account"),
  removeAccount: (id) => ipcRenderer.invoke("stayline:remove-account", id),
  renameAccount: (label, id) => ipcRenderer.invoke("stayline:rename-account", { label, id }),
